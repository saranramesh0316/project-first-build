...
const FoodOrderModal = ({ open, onClose }: FoodOrderModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-background max-w-md mx-auto animate-in slide-in-from-bottom duration-300">
      {/* Header */}
      ...
      {cartCount > 0 && !orderPlaced && (
        <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md p-4 bg-card border-t border-border z-10">
          <button
