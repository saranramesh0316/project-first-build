  ...
  return (
    <div className="mx-4 -mt-12 relative z-20">
        ...
        <defs>
          <clipPath id="ticket-clip">
            <path d={`
              ...
              Q 100% 0, 100% 16
              V calc(50% - 12px)
              A 12 12 0 0 1 100% calc(50% + 12px)
              V calc(100% - 16px)
              Q 100% 100%, calc(100% - 16px) 100%
              H 16
              Q 0 100%, 0 calc(100% - 16px)
              V calc(50% + 12px)
              A 12 12 0 0 1 0 calc(50% - 12px)
              V 16
              Q 0 0, 16 0
              Z
            `} />
      ...
      <div className="relative">
        {/* Background with ticket shape using pseudo-notches */}
        <div className="bg-card rounded-2xl shadow-lg shadow-background/50 overflow-hidden">
          ...
          {/* Maize border layer - sits behind content, clipped by notches */}
          <div className="absolute inset-0 rounded-2xl border border-primary/60 pointer-events-none" />

          {/* Left notch border cover - covers the straight border at notch */}
          <div className="absolute top-1/2 -translate-y-1/2 -left-3 w-6 h-6 rounded-full bg-background z-20 border border-primary/60" />
          <div className="absolute top-1/2 -translate-y-1/2 -right-3 w-6 h-6 rounded-full bg-background z-20 border border-primary/60" />
